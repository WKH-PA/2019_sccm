...
<div class="link_page">
  <div class="pagewrap">
    <ul>
      ...
      <li><a href="<?=$full_url ?>"><i class="fa fa-home"></i><?=$glo_lang['trang_chu'] ?></a><?=$is_search ? ' // '. $glo_lang['tim_kiem'] : GET_bre($arr_running['id'], $slug_step, $full_url, $lang, $thongtin_step, $slug_table) ?></li>
      <div class="clr"></div>
    </ul>
  </div>
</div>
