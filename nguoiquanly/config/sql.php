...
if (is_string($db)) {
    $is_connect = "off";
    if ($redis_on_off != "on" && $cache_file != "on") {
...
if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'webdemo4.pavietnam.vn' || $_SERVER['HTTP_HOST'] == "172.16.90.125") {
    $file_coder = @$docpat[0];
