...
<div class="box p10">
  ...
  <!-- <div class="form-group">
    <label for="exampleInputFile2">Ảnh tin lớn <?="(620px x 380px)"  ?></label>
  ...
  <?php if($step == 8){ ?>
  <div class="form-group">
    <label>Sự kiện diễn ra</label>
    <div class="input-group date">
      <div class="input-group-addon">
        <i class="fa fa-calendar"></i>
      </div>
      <input name="capnhat" type="text" class="form-control pull-right datepicker" id="datepicker" value='<?=$capnhat ?>'>
    </div>
  </div>
  <?php } ?>
