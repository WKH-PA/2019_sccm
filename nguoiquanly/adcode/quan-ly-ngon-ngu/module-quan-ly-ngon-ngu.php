                ...
                <div class="box">
                    ...
                    <div style="margin: 10px 10px 0;">
                        <label style="margin-right: 10px">
                            <input class="minimal check_js_ngonngu" type="checkbox" data="0" onclick="is_check_nn(0, this)"> Mặc định [0]
                        </label>
                        <label style="margin-right: 10px">
                            <input class="minimal check_js_ngonngu" type="checkbox" data="1" onclick="is_check_nn(0, this)"> Thành viên [1]
                        </label>
                        <label style="margin-right: 10px">
                            <input class="minimal check_js_ngonngu" type="checkbox" data="2" onclick="is_check_nn(0, this)"> Giỏ hàng [2]
                        </label>
                        <label>
                            <input class="minimal check_js_ngonngu" type="checkbox" data="3" onclick="is_check_nn(0, this)"> Sản phẩm [3]
                        </label>
                        <label>
                            <input class="minimal check_js_ngonngu" type="checkbox" data="4" onclick="is_check_nn(0, this)"> Đăng ký nhận mail [4]
                        </label>
                        <script>
                                $(".check_js_ngonngu").on('ifChecked', function(event) {
                                    var num = $(this).attr('data');
                                    $('.is_check_' + num).iCheck('check');
                                });
                                $(".check_js_ngonngu").on('ifUnchecked', function(event) {
                                    var num = $(this).attr('data');
                                    $('.is_check_' + num).iCheck('uncheck');
                                });
                        </script>
                    </div>
                    <?php } ?>
                        ...
                        <table class="table table-hover table-danhsach">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="name">
                                          <input type="text" name="ncata_vi<?=$cl?>" value="<?=$text_lang_vi ?>">
                                        </div>
                                    </td>
                                    <?php if($lang_nb2){ ?>
                                    <td class="tienganh">
                                        <div class="name">
                                          <input type="text" name="ncata_en<?=$cl?>" value="<?=$text_lang_en ?>">
                                        </div>
                                    </td>
                                    <?php } ?>
                                    <?php if($lang_nb3){ ?>
                                    <td class="tienganh">
                                        <div class="name">
                                          <input type="text" name="ncata_cn<?=$cl?>" value="<?=$text_lang_cn ?>">
                                        </div>
                                    </td>
                                    <?php } ?>
                                    <?php if($lang_nb4){ ?>
                                    <td class="tienganh">
                                        <div class="name">
                                          <input type="text" name="ncata_jp<?=$cl?>" value="<?=$text_lang_jp ?>">
                                        </div>
                                    </td>
                                    <?php } ?>
                                    <?php if(isset($_SESSION['admin'])){ ?>
