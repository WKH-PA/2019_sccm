          ...
          <div class="nav-tabs-custom">
            <div class="tab-content">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="lang_vi" value="<?=!empty($lang_vi) ? $lang_vi : ''?>">
              </div>
              <?php if($lang_nb2){ ?>
              <div class="form-group ">
                <label>Ngôn ngữ (<?=_lang_nb2_key ?>)</label>
                <input type="text" class="form-control" name="lang_en" value="<?=!empty($lang_en) ? $lang_en : ''?>">
              </div>
              <?php } ?>
              <?php if($lang_nb3){ ?>
              <div class="form-group ">
