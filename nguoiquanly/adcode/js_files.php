...
<script>
  $('input.minimal_click').on('ifChanged', function(event){
    var check = 0;
    if($(this).is(":checked")) {
      check = 1;
    }
...
<script type="text/javascript">
	...
	window.CKEDITOR_BASEPATH='ckeditor';
	  $('.paEditor').each(function(){
	    CKEDITOR.replace( $(this).attr('name'), {"filebrowserBrowseUrl":"\/<?=$forder_goc ?>nguoiquanly\/bower_components\/ckfinder\/ckfinder.html","filebrowserImageBrowseUrl":"\/<?=$forder_goc ?>nguoiquanly\/bower_components\/ckfinder\/ckfinder.html?type=Images","filebrowserFlashBrowseUrl":"\/<?=$forder_goc ?>nguoiquanly\/bower_components\/ckfinder\/ckfinder.html?type=Flash","filebrowserUploadUrl":"\/<?=$forder_goc ?>nguoiquanly\/bower_components\/ckfinder\/core\/connector\/php\/connector.php?command=QuickUpload&type=Files","filebrowserImageUploadUrl":"\/<?=$forder_goc ?>nguoiquanly\/bower_components\/ckfinder\/core\/connector\/php\/connector.php?command=QuickUpload&type=Images","filebrowserFlashUploadUrl":"\/<?=$forder_goc ?>nguoiquanly\/bower_components\/ckfinder\/core\/connector\/php\/connector.php?command=QuickUpload&type=Flash"});
	  });
	 var settingSelect = {
        csvDispCount: 6,
