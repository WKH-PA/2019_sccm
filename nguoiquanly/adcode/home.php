...
?>
    ...
    <section class="content" style="min-height: 0; padding-bottom: 0;">
      <form action="nguoiquanly/index.php" method="get">
        <label style="margin-bottom: 0 !important;">
          ...
          <a href="nguoiquanly/index.php?clear=ok" style="border: 1px solid #ccc; height: 28px; padding: 0 15px; border-radius: 2px; float: left; background: #dddddd; color: #333; line-height: 28px; margin-left: 7px;">Clear</a>
          <div class="clr"></div>
        </label>
      </form>
