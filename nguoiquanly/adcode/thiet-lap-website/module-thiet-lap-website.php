            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tencongty_vi" value="<?=$tencongty_vi ?>">
                </div>
                <div class="form-group">
              ...
              <div class="tab-pane" id="tab_2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tencongty_en" value="<?=$tencongty_en ?>">
                </div>
                <div class="form-group">
                  <label>Số điện thoại (<?=_lang_nb2_key ?>)</label>
                  <input type="text" class="form-control" name="sodienthoai_en" value="<?=$sodienthoai_en ?>">
                </div>
                <div class="form-group">
                  <label>Hotine (<?=_lang_nb2_key ?>)</label>
                  <input type="text" class="form-control" name="hotline_en" value="<?=$hotline_en ?>">
                </div>
                <div class="form-group">
                  <label>Email (<?=_lang_nb2_key ?>)</label>
                  <input type="text" class="form-control" name="email_en" value="<?=$email_en ?>">
                </div>
                <div class="form-group">
              ...
              <div class="tab-pane" id="tab_3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tencongty_cn" value="<?=$tencongty_cn ?>">
                </div>
                <div class="form-group">
                  <label>Số điện thoại (<?=_lang_nb3_key ?>)</label>
                  <input type="text" class="form-control" name="sodienthoai_cn" value="<?=$sodienthoai_cn ?>">
                </div>
                <div class="form-group">
                  <label>Hotine (<?=_lang_nb3_key ?>)</label>
                  <input type="text" class="form-control" name="hotline_cn" value="<?=$hotline_cn ?>">
                </div>
                <div class="form-group">
                  <label>Email (<?=_lang_nb3_key ?>)</label>
                  <input type="text" class="form-control" name="email_cn" value="<?=$email_cn ?>">
                </div>
                <div class="form-group">
              ...
              <div class="tab-pane" id="tab_4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tencongty_jp" value="<?=$tencongty_jp ?>">
                </div>
                <div class="form-group">
                  <label>Số điện thoại (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="sodienthoai_jp" value="<?=$sodienthoai_jp ?>">
                </div>
                <div class="form-group">
                  <label>Hotine (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="hotline_jp" value="<?=$hotline_jp ?>">
                </div>
                <div class="form-group">
                  <label>Email (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="email_jp" value="<?=$email_jp ?>">
                </div>
                <div class="form-group">
                  <label>Địa chỉ (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="diachi_jp" value="<?=$diachi_jp ?>">
                </div>

                <div class="form-group">
                  <label>Seo Title (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="seo_title_jp" value="<?=$seo_title_jp ?>">
                </div>

                <div class="form-group">
                  <label>Seo Description (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="seo_description_jp" value="<?=$seo_description_jp ?>">
                </div>

                <div class="form-group">
                  <label>Seo keywords (<?=_lang_nb4_key ?>)</label>
                  <input type="text" class="form-control" name="seo_keywords_jp" value="<?=$seo_keywords_jp ?>">
                </div>
              </div>
              <?php } ?>
            </div>
